...
### PCA (folder)
* **PCA (theory).ipynd** contains mathematical explanations on how principal component analysis works. It also breifly explains ideas behind dimenaionality reduction and [principal component regression](https://en.wikipedia.org/wiki/Principal_component_regression).
